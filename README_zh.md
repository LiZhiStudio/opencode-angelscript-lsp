...
为 AI 编程 Agent 提供的 Angelscript 语言服务器。

> English docs: [README.md](README.md)基于 [Hazelight 的 vscode-unreal-angelscript](https://github.com/Hazelight/vscode-unreal-angelscript) 扩展中的语言服务器构建，支持 Claude Code、OpenCode 等 Agent 平台。
